<?php
$sql = "SELECT * FROM listing ORDER BY pid DESC LIMIT 6";
...
if ($result->num_rows >= 0) {
    ...
    echo '  <p style="color: black; margin-bottom: -2rem; font-size: 23px; font-weight: 20px; margin-left:10%;">Recent listings:</p><br><br>
